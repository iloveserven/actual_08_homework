...
def index():
    ...
    return render_template('index.html',accesslist=accesslist,username=username,is_admin=is_admin,page_int=int(page_int),page_num=int(page_num),page_size=int(page_size))
...
def user_list():
    ...
    return render_template('userlist.html',userlist=userlist,username=username,page_int=int(page_int),page_num=int(page_num),page_size=int(page_size))
