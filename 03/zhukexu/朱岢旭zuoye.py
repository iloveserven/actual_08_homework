...
for x in new_dict:
    list_dict.append([x,new_dict[x]])
for p in range(len(list_dict)):
    for l in range(len(list_dict)-1):
        if list_dict[l][1]>list_dict[l+1][1]:
            list_dict[l],list_dict[l+1] = list_dict[l+1],list_dict[l]
list_dict.reverse()
