...
with open('90blog_access.log','r+') as log_file:
	count_list = []
...
'''
res_str = res_str + tmp % ('NO','IP','Url','Status','count')
#统计记录出现的次数
count_dict = {}
...
for x in range(length):
	...
	if now_max[1] == pre_max[1]:
		...
		if x > 10:
			break
	res_str = res_str + tmp % (x+1-count,now_max[0][0],now_max[0][1],now_max[0][2],now_max[1])
	print now_max
